...
class SlugTest {
  ...
  void should_replace_title_with_slug_whitespace() {
    ...
    assertThat(slug.getValue()).isEqualTo("springboot-is-most-popular-frameworks");
  }
  ...
  void should_replace_title_with_slug_in_number() {
    ...
    assertThat(slug.getValue()).isEqualTo("springboot-2-4-1-change-spring-profiles-add");
  }
}